    ...
    return (
        <section id='servicos' className='container mx-auto py-9 flex flex-col gap-7 items-center justify-center text-primary'>
            ...
            <div className="flex gap-4  flex-wrap justify-center">
                <div className="item1 w-72 h-52 rounded-xl  text-center border-primary border-2 p-2.5  flex flex-col gap-4 ">
                ...
                <div className="item2  w-72 h-52 rounded-xl   text-center border-primary border-2 p-2.5  flex flex-col gap-4 ">
                ...
                <div className="item3  w-72 h-52 rounded-xl   text-center border-primary border-2 p-2.5  flex flex-col gap-4 ">
                ...
                <div className="item4  w-72 h-52 rounded-xl   text-center border-primary border-2 p-2.5  flex flex-col gap-4 ">
